...
public class CreateUserValidator : AbstractValidator<User>
{
    public CreateUserValidator()
    {
        ...
        RuleFor(x => x.Id).Empty().WithMessage("ID should not be provided when creating a user");
    }
}
...
public class UpdateUserValidator : AbstractValidator<User>
{
    public UpdateUserValidator()
    {
        ...
        RuleFor(x => x.Id).NotEmpty().WithMessage("ID is required when updating a user");
    }
}
